...
int main(int argv,char** argc)
{
    ...
    std::string mavlink_topic = std::string("/uav") + std::to_string(UAV_ID) + std::string("/mavlink/to");
    ros::topic::waitForMessage<mavros_msgs::Mavlink>(mavlink_topic, ros::Duration(50.0));
